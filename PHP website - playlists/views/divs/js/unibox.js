var UniBox = function () {
    ...
    function highlightSearchWords(string, searchString) {
        ...
        var words = searchString.replace(/[^a-zA-Z0-9Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸ]|\s+|\r?\n|\r/gmi, " ").replace(/[^a-zA-Z0-9Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸ]/g, " ").split(' ');
        ...
        jQuery.each(suggestOrderToUse, function (idx, key) {
            ...
            jQuery.each(values, function (index, suggest) {
                ...
                if (suggest['link'] != undefined && suggest['link'] != '') {
                    var suggestLine = '<div class="unibox-selectable" style="cursor: pointer;" onclick="window.location=' + "'" + suggest['link'] + "'" + ';">'; 
                    //var beginning = suggest['link'].substring(0, 7);
                    //var ending = suggest['link'].substring(7, suggest['link'].length);
                    //var suggestLine = '<div class="unibox-selectable" style="cursor: pointer;" onclick="window.location=' + suggest['link'] + ';">'; 
                }
